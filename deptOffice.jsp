...
if(session.getAttribute("userID") != null) {
   ...
   latitude = informationDAO.getLatitude();
   longitude = informationDAO.getLongitude();
   deptname = informationDAO.getName();
   building = informationDAO.getBuilding();
   deptnum = informationDAO.getNum();
...
%>
 ...
 <div style="width:100%; margin:30px 0px; text-align:center;"> 
   <button class="btn6 mr-4" type="button" onclick="location.href='deptOffice.jsp'" style="width:110px; height:90px;">
         <img src="./buttonimg/사무실.png" style="width: 50px; height: 50px;">
         <p>사무실</p>
      </button>
      <button class="btn2 mr-4" type="button" onclick="location.href='copyCategory.jsp'" style="width:110px; height:90px;">
      <img src="./buttonimg/복사기.png" style="width: 50px; height: 50px;">
         <p>복사기</p>
      </button>
      <button class="btn3 mr-4" type="button" onclick="location.href='vendingCategory.jsp'" style="width:110px; height:90px;">
         <img src="./buttonimg/자판기.png" style="width: 50px; height: 50px;">
         <p>자판기</p>
      </button>
      <button class="btn4 mr-4" type="button" onclick="location.href='storeCategory.jsp'" style="width:110px; height:90px;">
         <img src="./buttonimg/편의점.png" style="width: 50px; height: 50px;">
         <p>편의점</p>
      </button>
      <button class="btn5 mr-4" type="button" onclick="location.href='machineCategory.jsp'" style="width:110px; height:90px;">
