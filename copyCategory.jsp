...
if(session.getAttribute("userID") != null) {
   ...
   ArrayList state= new ArrayList();
      ...
      latitude = informationDAO.copyLatitude();
      longitude = informationDAO.copyLongitude();
...
<!-- 카테고리버튼 -->
   ...
   <button class="btn1 mr-4" style="width: 120px; height: 90px;" type="button" onclick="location.href='deptOffice.jsp'">
      ...
      <button class="btn7 mr-4" style="width: 120px; height: 90px;" type="button" onclick="location.href='copyCategory.jsp'">
