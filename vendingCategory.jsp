...
if(session.getAttribute("userID") != null) {
   ...
   ArrayList state= new ArrayList();
      ...
      latitude = informationDAO.vendingLatitude();
      longitude = informationDAO.vendingLongitude();
      name = informationDAO.vendingName();
     state = informationDAO.vendingState();
...
<!-- 카테고리버튼 -->
   ...
   <button class="btn1 mr-4" style="width: 120px; height: 90px;" type="button" onclick="location.href='deptOffice.jsp'">
      ...
      <button class="btn8 mr-4"style="width: 120px; height: 90px;" type="button" onclick="location.href='vendingCategory.jsp'">
