...
if(session.getAttribute("userID") != null) {
   ...
   ArrayList name= new ArrayList();
      ...
      latitude = informationDAO.storeLatitude();
      longitude = informationDAO.storeLongitude();
      name = informationDAO.storeName();
...
<!-- 카테고리버튼 -->
   ...
   <button class="btn1 mr-4" style="width: 120px; height: 90px;" type="button" onclick="location.href='deptOffice.jsp.jsp'">
      ...
      <button class="btn9 mr-4" style="width: 120px; height: 90px;" type="button" onclick="location.href='storeCategory.jsp'">
         <img src="./buttonimg/편의점.png" style="width: 50px; height: 50px;">
         <p>편의점</p>
      </button>
      <button class="btn5 mr-4" style="width: 120px; height: 90px;" type="button" onclick="location.href='machineCategory.jsp'">
